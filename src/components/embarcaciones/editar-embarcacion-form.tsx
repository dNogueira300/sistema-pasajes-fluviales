...
export default function EditarEmbarcacionForm({
  ...
  const hasChanges = embarcacion
    ? formulario.nombre !== embarcacion.nombre ||
      formulario.capacidad !== embarcacion.capacidad ||
      formulario.estado !== embarcacion.estado ||
      formulario.tipo !== (embarcacion.tipo || "")
    : false;
  ...
  return (
    ...
    >
      <div className="p-6">
        <form id="editar-embarcacion-form" onSubmit={handleSubmit} className="space-y-6">
          <div>
